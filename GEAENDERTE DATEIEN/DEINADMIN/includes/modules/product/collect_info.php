 ...
 * @version $Id: collect_info.php for pdf attachment 2023-12-03 13:41:50Z webchills $
 */
...
?>
  ...
  <div class="form-group">
    ...
    <hr>
<!--bof pdf attachment-->
<h2><?php echo TEXT_PRODUCTS_PDF_ATTACHMENT; ?></h2> 
...
<?php
    if (!empty($pInfo->products_pdf_attachment)) { ?>
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9 col-md-6">
             <?php echo TEXT_PDF_ATTACHMENT_CURRENT;?>  <?php echo $pInfo->products_pdf_attachment; ?>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-9 col-md-6">
             <?php echo TEXT_PDF_ATTACHMENT_NONEXISTENT;?>
...
<div class="form-group">
        <?php echo zen_draw_label(TEXT_EDIT_PRODUCTS_PDF_ATTACHMENT, 'products_pdf_attachment', 'class="col-sm-3 control-label"'); ?>
        <div class="col-sm-9 col-md-9 col-lg-6">
            <?php echo zen_draw_file_field('products_pdf_attachment', '', 'class="form-control" id="products_pdf_attachment"'); ?>
            <?php echo zen_draw_hidden_field('products_previous_pdf_attachment', $pInfo->products_pdf_attachment); ?>
        </div>
    </div>
<div class="form-group">
          <?php echo zen_draw_label(TEXT_PRODUCTS_PDF_ATTACHMENT_DIR, 'pdf_attachment_dir', 'class="col-sm-3 control-label"'); ?>
          <div class="col-sm-9 col-md-9 col-lg-6">
          <?php echo zen_draw_pull_down_menu('pdf_attachment_dir', $dir_attach_info, $default_attach_directory, 'class="form-control" id="pdf_attachment_dir"'); ?>
        </div>     
      </div>  
   <?php
    if (!empty($pInfo->products_pdf_attachment)) { ?>   
       ...
       <p class="col-sm-3 control-label"><?php echo TEXT_PDF_ATTACHMENT_DELETE; ?></p>
<div class="col-sm-9 col-md-9 col-lg-6">
 ...
 <?php }
    ...
    <div class="form-group">
    	<p class="col-sm-3 control-label"><?php echo TEXT_PDF_ATTACHMENT_OVERWRITE; ?></p>
...
<div class="col-sm-9 col-md-9 col-lg-6">
    ...
    <div class="form-group">
        <?php echo zen_draw_label(TEXT_PRODUCTS_PDF_ATTACHMENT_MANUAL, 'products_pdf_attachment_manual', 'class="col-sm-3 control-label"'); ?>
        <div class="col-sm-9 col-md-9 col-lg-6">
            <?php echo zen_draw_input_field('products_pdf_attachment_manual', '', 'class="form-control" id="products_pdf_attachment_manual"'); ?>
        </div>
    </div>
    <hr>
<!--eof pdf attachment-->
