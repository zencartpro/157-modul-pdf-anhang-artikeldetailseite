 ...
 * @version $Id: copy_product_confirm.php for pdf attachment 2022-05-30 20:31:16Z webchills $
 */
...
if (isset($_POST['products_id'], $_POST['categories_id'])) {
    ...
    foreach ($descriptions as $description) {
      $db->Execute("INSERT INTO " . TABLE_PRODUCTS_DESCRIPTION . " (products_id, language_id, products_name, pdf_attachment_name, products_merkmale, products_description, products_url)
