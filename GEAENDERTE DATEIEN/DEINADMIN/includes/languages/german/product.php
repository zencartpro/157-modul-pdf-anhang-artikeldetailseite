 ...
 * @version $Id: product.php for pdf attachment 2022-06-01 15:52:04Z webchills $
 */
...
define('TEXT_PRODUCTS_PDF_ATTACHMENT_FILE', 'Datei für pdf Anhang:');
define('TEXT_PDF_ATTACHMENT_NONEXISTENT', 'Derzeit kein pdf zugeordnet');
define('TEXT_EDIT_PRODUCTS_PDF_ATTACHMENT', 'pdf Anhang bearbeiten');
define('TEXT_PRODUCTS_PDF_ATTACHMENT', 'pdf Anhang zum Artikel:');
define('TEXT_PRODUCTS_PDF_ATTACHMENT_DIR', 'Uploadverzeichnis:');
define('TEXT_PDF_ATTACHMENT_CURRENT', 'Aktuelle pdf Datei: ');
define('TEXT_PDF_ATTACHMENT_DELETE', '<strong>pdf entfernen?</strong>  Hinweis: Entfernt die Verknüpfung pdf/Artikel<br>(pdf Datei wird dabei NICHT vom Server entfernt)');
define('TEXT_PDF_ATTACHMENT_OVERWRITE', 'Bestehendes pdf überschreiben?<br>Verwenden Sie "Nein" bei manuell eingegebenem Namen');
