...
define('TEXT_PRODUCTS_PDF_ATTACHMENT_FILE', 'File for pdf attachment:');
define('TEXT_PDF_ATTACHMENT_NONEXISTENT', 'Currently no pdf added');
define('TEXT_EDIT_PRODUCTS_PDF_ATTACHMENT', 'Edit pdf attachment');
...
define('TEXT_PDF_ATTACHMENT_DELETE', '<strong>Remove pdf</strong>? Removes the pdf from product<br>pdf will NOT be deleted from server:');
define('TEXT_PDF_ATTACHMENT_OVERWRITE', 'Overwrite existing pdf?<br> Use "No" if you enter the filename manually');
